...
const fuse = new Fuse(
  [
    ...
    'client.heatmapPoints.retrieve',
    'client.heatmapSchedules.create',
    'client.heatmapSchedules.list',
    'client.heatmapSchedules.pause',
    'client.heatmapSchedules.resume',
    'client.heatmapSchedules.retrieve',
    'client.heatmapSchedules.update',
    'client.heatmaps.competitors',
    'client.heatmaps.create',
    'client.heatmaps.list',
    'client.heatmaps.listLocations',
    'client.heatmaps.retrieve',
    'client.phoneCalls.list',
  ],
