...
import { ThriveMcp, ClientOptions } from 'leadsnap-test-typescript';
...
const fuse = new Fuse(
  [
    ...
    'client.public.api.v1.contacts.retrieveContact',
    'client.public.api.v1.formSubmissions.listFormSubmissions',
    'client.public.api.v1.heatmapPoints.generateGridPoints',
    'client.public.api.v1.heatmapPoints.retrieveHeatmapPoint',
    'client.public.api.v1.heatmapSchedules.createSchedule',
    'client.public.api.v1.heatmapSchedules.listSchedules',
    'client.public.api.v1.heatmapSchedules.pauseSchedule',
    'client.public.api.v1.heatmapSchedules.resumeSchedule',
    'client.public.api.v1.heatmapSchedules.retrieveSchedule',
    'client.public.api.v1.heatmapSchedules.updateSchedule',
    'client.public.api.v1.heatmaps.createHeatmap',
    'client.public.api.v1.heatmaps.listHeatmaps',
    'client.public.api.v1.heatmaps.listLocations',
    'client.public.api.v1.heatmaps.retrieveHeatmap',
    'client.public.api.v1.heatmaps.retrieveHeatmapCompetitors',
