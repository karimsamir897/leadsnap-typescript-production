...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    stainlessPath: '(resource) contacts > (method) timeline',
    qualified: 'client.contacts.timeline',
  ...
  },
  {
    ...
    stainlessPath: '(resource) contacts > (method) conversations',
    qualified: 'client.contacts.conversations',
  ...
  },
  {
    ...
    stainlessPath: '(resource) form_submissions > (method) list',
    qualified: 'client.formSubmissions.list',
    params: [
      'client?: number[];',
      'company_id?: number;',
      'created_at_from?: string;',
  ...
  },
  {
    ...
    stainlessPath: '(resource) heatmap_points > (method) generate_grid',
    qualified: 'client.heatmapPoints.generateGrid',
    params: [
      'grid_radius: number;',
      'grid_size: number;',
      'lat: number;',
  ...
  },
  {
    ...
    stainlessPath: '(resource) heatmap_points > (method) retrieve',
    qualified: 'client.heatmapPoints.retrieve',
    ...
    markdown:
      "## retrieve\n\n`client.heatmapPoints.retrieve(heatmap_id: number, point_id: number): { id?: number; index?: number; lat?: number; lng?: number; places?: object[]; rank?: number; }`\n\n**get** `/public/api/v1/heatmaps/{heatmap_id}/points/{point_id}`\n\nReturns details for a single grid point within a heatmap, including its coordinates, rank, and surrounding place rankings.\n\n### Parameters\n\n- `heatmap_id: number`\n\n- `point_id: number`\n\n### Returns\n\n- `{ id?: number; index?: number; lat?: number; lng?: number; places?: { id?: number; address?: string; ave_review_rating?: number; google_place_id?: string; name?: string; ranking?: number; review_count?: number; }[]; rank?: number; }`\n\n  - `id?: number`\n  - `index?: number`\n  - `lat?: number`\n  - `lng?: number`\n  - `places?: { id?: number; address?: string; ave_review_rating?: number; google_place_id?: string; name?: string; ranking?: number; review_count?: number; }[]`\n  - `rank?: number`\n\n### Example\n\n```typescript\nimport ThriveMcp from 'leadsnap-test-typescript';\n\nconst client = new ThriveMcp();\n\nconst heatmapPoint = await client.heatmapPoints.retrieve(129410, { heatmap_id: 425591 });\n\nconsole.log(heatmapPoint);\n```",
    perLanguage: {
      typescript: {
        method: 'client.heatmapPoints.retrieve',
        example:
          "import ThriveMcp from 'leadsnap-test-typescript';\n\nconst client = new ThriveMcp({\n  bearerToken: process.env['THRIVE_MCP_BEARER_TOKEN'], // This is the default and can be omitted\n});\n\nconst heatmapPoint = await client.heatmapPoints.retrieve(129410, { heatmap_id: 425591 });\n\nconsole.log(heatmapPoint.id);",
      },
      http: {
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) heatmap_schedules > (method) list',
    qualified: 'client.heatmapSchedules.list',
    params: [
  ...
  },
  {
    ...
    stainlessPath: '(resource) heatmap_schedules > (method) create',
    qualified: 'client.heatmapSchedules.create',
    params: [
  ...
  },
  {
    ...
    stainlessPath: '(resource) heatmap_schedules > (method) retrieve',
    qualified: 'client.heatmapSchedules.retrieve',
    params: ['schedule: number;'],
    response:
      '{ id?: number; draw_type?: string; google_location?: string; grid_points?: { lat?: string; lng?: string; }[]; grid_size?: number; keywords?: string[]; lat?: string; lead_source_id?: string; length_unit?: string; lng?: string; name?: string; place?: { id?: number; address?: string; ave_review_rating?: number; feature_id?: string; google_place_id?: string; google_place_serial?: string; latitude?: string; longitude?: string; main_category?: string; map_url?: string; name?: string; phone?: string; place_url?: string; ranking?: string; related_categories?: string[]; review_count?: number; thumbnail_url?: string; website_url?: string; }; place_id?: number; radius?: number; schedule_config?: { id?: number; ai_recurring?: number; created_at?: string; delete_oldpost_on_recurring?: number; is_recurring?: number; last_schedule_ran_at?: string; recurring_count?: number; repeat_every?: number; repeat_on?: string; repeat_type?: string; scheduled_at?: string; status?: string; stop_reason?: string; timezone?: string; updated_at?: string; }; status?: string; stop_reason?: string; zoom_level?: string; }',
    markdown:
      "## retrieve\n\n`client.heatmapSchedules.retrieve(schedule: number): { id?: number; draw_type?: string; google_location?: string; grid_points?: object[]; grid_size?: number; keywords?: string[]; lat?: string; lead_source_id?: string; length_unit?: string; lng?: string; name?: string; place?: object; place_id?: number; radius?: number; schedule_config?: object; status?: string; stop_reason?: string; zoom_level?: string; }`\n\n**get** `/public/api/v1/heatmap/schedules/{schedule}`\n\nReturns full details of a single heatmap schedule including its configuration and next run time.\n\n### Parameters\n\n- `schedule: number`\n\n### Returns\n\n- `{ id?: number; draw_type?: string; google_location?: string; grid_points?: { lat?: string; lng?: string; }[]; grid_size?: number; keywords?: string[]; lat?: string; lead_source_id?: string; length_unit?: string; lng?: string; name?: string; place?: { id?: number; address?: string; ave_review_rating?: number; feature_id?: string; google_place_id?: string; google_place_serial?: string; latitude?: string; longitude?: string; main_category?: string; map_url?: string; name?: string; phone?: string; place_url?: string; ranking?: string; related_categories?: string[]; review_count?: number; thumbnail_url?: string; website_url?: string; }; place_id?: number; radius?: number; schedule_config?: { id?: number; ai_recurring?: number; created_at?: string; delete_oldpost_on_recurring?: number; is_recurring?: number; last_schedule_ran_at?: string; recurring_count?: number; repeat_every?: number; repeat_on?: string; repeat_type?: string; scheduled_at?: string; status?: string; stop_reason?: string; timezone?: string; updated_at?: string; }; status?: string; stop_reason?: string; zoom_level?: string; }`\n\n  - `id?: number`\n  - `draw_type?: string`\n  - `google_location?: string`\n  - `grid_points?: { lat?: string; lng?: string; }[]`\n  - `grid_size?: number`\n  - `keywords?: string[]`\n  - `lat?: string`\n  - `lead_source_id?: string`\n  - `length_unit?: string`\n  - `lng?: string`\n  - `name?: string`\n  - `place?: { id?: number; address?: string; ave_review_rating?: number; feature_id?: string; google_place_id?: string; google_place_serial?: string; latitude?: string; longitude?: string; main_category?: string; map_url?: string; name?: string; phone?: string; place_url?: string; ranking?: string; related_categories?: string[]; review_count?: number; thumbnail_url?: string; website_url?: string; }`\n  - `place_id?: number`\n  - `radius?: number`\n  - `schedule_config?: { id?: number; ai_recurring?: number; created_at?: string; delete_oldpost_on_recurring?: number; is_recurring?: number; last_schedule_ran_at?: string; recurring_count?: number; repeat_every?: number; repeat_on?: string; repeat_type?: string; scheduled_at?: string; status?: string; stop_reason?: string; timezone?: string; updated_at?: string; }`\n  - `status?: string`\n  - `stop_reason?: string`\n  - `zoom_level?: string`\n\n### Example\n\n```typescript\nimport ThriveMcp from 'leadsnap-test-typescript';\n\nconst client = new ThriveMcp();\n\nconst heatmapSchedule = await client.heatmapSchedules.retrieve(10);\n\nconsole.log(heatmapSchedule);\n```",
    perLanguage: {
      typescript: {
        method: 'client.heatmapSchedules.retrieve',
        example:
          "import ThriveMcp from 'leadsnap-test-typescript';\n\nconst client = new ThriveMcp({\n  bearerToken: process.env['THRIVE_MCP_BEARER_TOKEN'], // This is the default and can be omitted\n});\n\nconst heatmapSchedule = await client.heatmapSchedules.retrieve(10);\n\nconsole.log(heatmapSchedule.id);",
      },
      http: {
  ...
  },
  {
    ...
    stainlessPath: '(resource) heatmap_schedules > (method) update',
    qualified: 'client.heatmapSchedules.update',
    params: [
      'schedule_id: number;',
  ...
  },
  {
    ...
    stainlessPath: '(resource) heatmap_schedules > (method) pause',
    qualified: 'client.heatmapSchedules.pause',
  ...
  },
  {
    ...
    stainlessPath: '(resource) heatmaps > (method) list',
    qualified: 'client.heatmaps.list',
    params: [
  ...
  },
  {
    ...
    stainlessPath: '(resource) heatmaps > (method) create',
    qualified: 'client.heatmaps.create',
    params: [
      'distanceType: string;',
      'grid_radius: number;',
      'grid_size: number;',
  ...
  },
  {
    ...
    stainlessPath: '(resource) heatmaps > (method) list_locations',
    qualified: 'client.heatmaps.listLocations',
    params: [
  ...
  },
  {
    ...
    stainlessPath: '(resource) heatmaps > (method) retrieve',
    qualified: 'client.heatmaps.retrieve',
  ...
  },
  {
    ...
    stainlessPath: '(resource) heatmaps > (method) competitors',
    qualified: 'client.heatmaps.competitors',
    params: ['heatmap: number;'],
    response:
  ...
  },
  {
    ...
    stainlessPath: '(resource) phone_calls > (method) list',
    qualified: 'client.phoneCalls.list',
    params: [
      'client?: number[];',
      'company_id?: number;',
      'created_at_from?: string;',
