...
- **search_docs** — search the SDK documentation (methods, params, examples) using a local in-memory index.
- **execute** — run JavaScript against the Thrive SDK; the code runs in a remote Deno sandbox.
