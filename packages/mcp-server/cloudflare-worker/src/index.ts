...
import { McpOptions } from 'leadsnap-test-mcp-server/options';
import { initMcpServer, newMcpServer } from 'leadsnap-test-mcp-server/server';
...
function fallbackMcpServer(): McpServer {
  return new McpServer(
    { name: 'leadsnap_test_typescript_api', version: '0.1.0' },
