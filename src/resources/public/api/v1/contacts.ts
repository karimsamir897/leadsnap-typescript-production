...
export class Contacts extends APIResource {
   ...
   * ```ts
   * const response =
   *   await client.public.api.v1.contacts.listContacts();
   * ```
   */
  listContacts(
   ...
   * ```ts
   * const response =
   *   await client.public.api.v1.contacts.retrieveContact(42);
   * ```
   */
  retrieveContact(contactID: number, options?: RequestOptions): APIPromise<ContactRetrieveContactResponse> {
   ...
   * ```ts
   * const response =
   *   await client.public.api.v1.contacts.contactTimeline(42);
   * ```
   */
  contactTimeline(
    contactID: number,
    query: ContactContactTimelineParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ContactContactTimelineResponse> {
   ...
   * ```ts
   * const response =
   *   await client.public.api.v1.contacts.contactConversations(
   *     42,
   *   );
   * ```
   */
  contactConversations(
    contactID: number,
    query: ContactContactConversationsParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ContactContactConversationsResponse> {
    return this._client.get(path`/public/api/v1/contacts/${contactID}/conversations`, { query, ...options });
  }
}

export interface ContactContactConversationsResponse {
  data?: Array<ContactContactConversationsResponse.Data>;

  meta?: ContactContactConversationsResponse.Meta;
}

export namespace ContactContactConversationsResponse {
...
export interface ContactContactTimelineResponse {
  data?: Array<ContactContactTimelineResponse.Data>;

  meta?: ContactContactTimelineResponse.Meta;
}

export namespace ContactContactTimelineResponse {
  export interface Data {
    id?: string;
...
export interface ContactListContactsResponse {
  ...
  data?: Array<ContactListContactsResponse.Data>;

  last_page?: number;

  meta?: ContactListContactsResponse.Meta;
...
export interface ContactRetrieveContactResponse {
  ...
  company?: ContactRetrieveContactResponse.Company;
  ...
  lead?: ContactRetrieveContactResponse.Lead;
...
export namespace ContactRetrieveContactResponse {
  export interface Company {
    id?: number;
...
export interface ContactContactTimelineParams {
  /**
...
export interface ContactContactConversationsParams {
  /**
